...
<html lang="fr">
    <head>
        <title>Journée Recherche et Développement 2022</title>
        <meta charset="utf-8">
    ...
    <body class="body-bg bg-dark text-light">
...
<figure class="map">
    <img  src="img/map.png" class="figure-img img-fluid rounded img-thumbnail" width="600" alt="map UFRST">
    <figcaption class="figure-caption text-end">La journée se déroulera dans le hall du bâtiment propédeutique.</figcaption>
</figure>
                                    ...
                                    <li>
                                        <ul class="nav flex-column">
                                            <li class="nav-item mb-2">
                                                <a style="text-decoration: none;" target="_blank" class="link-light" href="mailto:rd.2022.info@gmail.com?subject=Informations%20supplémentaires"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-chat-left-text" viewBox="0 0 16 16">
                                                    <path d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
                                                    <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zM3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6zm0 2.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5z"/>
                                                </svg>
                                                rd.2022.info@gmail.com</a>
                                            </li>
                                            <li class="nav-item mb-2">
                                                <a style="text-decoration: none;" target="_blank" class="link-light" href="https://www.instagram.com/rnday_info/"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
